...
static inline
snd_mask_t *hw_param_mask(const snd_pcm_hw_params_t *params,
			  int var)
{
...
static inline
snd_interval_t *hw_param_interval(const snd_pcm_hw_params_t *params,
				  int var)
{
	return (snd_interval_t*)&params->intervals[var - SNDRV_PCM_HW_PARAM_FIRST_INTERVAL];
}
